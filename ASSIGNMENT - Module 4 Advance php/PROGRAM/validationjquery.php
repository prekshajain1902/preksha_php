...
<body>
    <form action="" id="form1" method="post">
        ...
        <div class="form-group">
            <label>email:</label>
            <input type="text" name="email" class="form-control" data-bvalidator="required,email" placeholder="enter your cpassword">
        </div>
        <div class="form-group">
            <label>phone number:</label>
            <input type="text" name="email" class="form-control" data-bvalidator="required,number" placeholder="enter your cpassword">
        </div>
        <div class="form-group">
            <label>pinncode number</label>
            <input type="text" name="pincodenumber" class="form-control" data-bvalidator="required,number" placeholder="enter your pincode number">
        </div>
